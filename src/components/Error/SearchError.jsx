...
const SearchError = ({ errorMsg }) => {
	return (
		<>
			<div
				className="flex items-center py-2 px-9  max-sm:p-[inherit] text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800 "
				role="alert"
			>
				<svg
